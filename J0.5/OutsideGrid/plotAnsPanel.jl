...
Htrue = readcsv("./InputOutGrid/Htrue.csv");
Ttrue = readcsv("./InputOutGrid/Ttrue.csv");
Wtrue = readcsv("./InputOutGrid/Wtrue.csv");
...
Wtp = vstack(hstack( spy(WtrueWide[:,:,1], Guide.title(""), Guide.xlabel(""), Guide.xticks(ticks=nothing),Theme(minor_label_font_size = 22pt), Scale.color_continuous(minvalue=0.0, maxvalue=0.5)),
           spy(WaWide[:,:,3], Guide.title(""), Guide.xlabel(""), Guide.xticks(ticks=nothing),Theme(minor_label_font_size = 22pt), Scale.color_continuous(minvalue=0.0, maxvalue=0.5)))
  , hstack( spy(WtrueWide[:,:,2], Guide.title(""), Guide.xlabel(""), Guide.xticks(ticks=nothing),Theme(minor_label_font_size = 22pt), Scale.color_continuous(minvalue=0.0, maxvalue=0.5)),
           spy(WaWide[:,:,2], Guide.title(""), Guide.xlabel(""), Guide.xticks(ticks=nothing),Theme(minor_label_font_size = 22pt), Scale.color_continuous(minvalue=0.0, maxvalue=0.5)))
  , hstack( spy(WtrueWide[:,:,3], Guide.title(""),  Guide.xlabel(""), Guide.xticks(ticks=nothing),Theme(minor_label_font_size = 22pt), Scale.color_continuous(minvalue=0.0, maxvalue=0.5)),
           spy(WaWide[:,:,1], Guide.title(""), Guide.xlabel(""), Guide.xticks(ticks=nothing),Theme(minor_label_font_size = 22pt), Scale.color_continuous(minvalue=0.0, maxvalue=0.5)))
  );
...
X = readcsv("./InputOutGrid/Observation.csv");
